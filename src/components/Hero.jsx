...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative md:min-h-screen flex flex-col md:flex-row items-center justify-between text-white px-4 sm:px-6 md:px-8 overflow-hidden"
    ...
    >
      ...
      >
        <motion.h3
          ...
          className="text-green-400 text-xs sm:text-sm font-jetbrains"
        >
