...
export default function TestimonialSlider() {
  ...
  return (
    <section id="reviews" className="bg-black text-white flex flex-col">
      <div className="text-center">
        ...
        <p className="text-gray-400 mb-12">
          Testimonials from organizations that have successfully integrated AI
          consciousness
        </p>
      </div>
      <div className="bg-[#0c0f16] text-white rounded-2xl p-8 border border-green-900/40 shadow-lg w-full max-w-4xl mx-auto mt-12"
      >
